...
const NewWithdrawal = () => {
  ...
  const handleGetUser = async () => {
    setLoading(true);
    await axios
      .get(`https://ultima-finances-backend.vercel.app/api/userdata/${id}`)
      .then((response) => {
        setLoading(false);
  ...
  const url = `https://ultima-finances-backend.vercel.app/api/requestwithdrawcode/${id}`;
  const urlll = `https://ultima-finances-backend.vercel.app/api/withdraw/${id}`;
  const urlprofit = `https://ultima-finances-backend.vercel.app/api/transferprofittoaccount/${id}`;
  const urlemail = `https://ultima-finances-backend.vercel.app/api/withdrawalemailsend/${id}`;
